...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionZarzadzanie_zawodami = QAction(MainWindow)
        self.actionZarzadzanie_zawodami.setObjectName(u"actionZarzadzanie_zawodami")
        self.actionZarzadzanie_zawodami.setMenuRole(QAction.NoRole)
        ...
        self.gridLayout_3.addWidget(self.tabWidget_zawody, 1, 0, 1, 3)
        ...
        self.menuBagno.addSeparator()
        self.menuBagno.addAction(self.actionZarzadzanie_zawodami)
        self.menuBagno.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionZarzadzanie_zawodami.setText(QCoreApplication.translate("MainWindow", u"Zarz\u0105dzanie zawodami", None))
#if QT_CONFIG(tooltip)
        self.actionZarzadzanie_zawodami.setToolTip(QCoreApplication.translate("MainWindow", u"Otw\u00f3rz Zawody", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionZarzadzanie_zawodami.setStatusTip(QCoreApplication.translate("MainWindow", u"Otwiera zapisane zawody", None))
#endif // QT_CONFIG(statustip)
